...
public enum JxContentTableViewCell: String {
    
    case EpisodeCell = "EpisodeCell"
    case EpisodeCollectionCell = "EpisodeCollectionCell"
    
    case GroupCell = "GroupCell"
    case PodcastTableViewCell = "PodcastTableViewCell"
    
    case InfoCell = "InfoCell"
    case PodcastCell = "PodcastCell"
    ...
    case InAppPurchaseCell = "InAppPurchaseCell"
    case InAppPurchase3xCell = "InAppPurchase3xCell"
